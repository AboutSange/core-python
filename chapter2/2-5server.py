...
while True:
    ...
    cs.sendall('welcome to my server')
    while True:
        ...
        if data:
            ...
            if data == 'os':
                ...
                data_send = os.listdir(os.curdir)
            elif data == 'ls dir':
                data_send = [i for i in os.listdir(os.curdir) if os.path.isfile(i)]
            ...
            cs.sendall('{} {}'.format(time.ctime(), data_send))
        else:
            break
    cs.close()
ss.close()
